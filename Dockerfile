...
# Step 12: Create necessary cache directories and set proper permissions for the non-root user
RUN mkdir -p /var/cache/nginx/client_temp /var/cache/nginx/body_temp /var/cache/nginx/proxy_temp && \
